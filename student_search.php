                                ...
                                <div class="table-container table-responsive">
                                    <div class="table-responsive ">
                                        ...
                                        if (isset($_POST['submit'])) {
                                           ...
                                           var_dump($query);
                                           $connect = mysqli_connect("localhost","root","","school");
                                            $check = mysqli_query($connect, " SELECT * FROM `students` WHERE id = $key") or die("not deleted".mysqli_error());;
                                            var_dump($check);   
                                            
                                            if (mysqli_num_rows($check)> 0) {
                                               
                                                $queryDelete = mysqli_query( $connect, " DELETE FROM students WHERE id = '$key' ")  or die("not deleted".mysqli_error());
                                                ...
                                                echo "<h3>The Record Does Not Exist</h3>";} 
                                            }
                                        ...
                                        <form  method="post"> 
                                            ...
                                            <tbody class="table-striped">
                                                ...
                                                <?php while($row = mysqli_fetch_array($search_result)):?>
                                                    ...
                                                    <td><button class="btn btn-danger" id="btn_delete" name="submit" type="submit">delete</button></td>
                                                    </tr> 
                                                    </form>                                          
                                                <?php endwhile;?>    
